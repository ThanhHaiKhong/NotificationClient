...
public struct NotificationClient: Sendable {
	...
	public var getNotifications: @Sendable (_ configuration: NotificationClient.NotifiesConfiguration) async throws -> [NotificationClient.Notification]
	public var getTopics: @Sendable (_ configuration: NotificationClient.TopicsConfiguration) async throws -> [NotificationClient.Topic]
	...
	public var deletes: @Sendable (_ configuration: NotificationClient.DeleteConfiguration) async throws -> Void
	...
	public var statusNotifications: @Sendable (_ configuration: NotificationClient.StatusConfiguration) async throws -> NotificationClient.StatusResponse
}
